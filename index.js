...
client.on("messageCreate", async (msg) => {
  ...
  //   if (msg.content.startsWith(`${process.env.prefix}howToRaid`)) {
  //     let embed = new EmbedBuilder()
  //       .setColor(0x0099ff)
  //       .setTitle("Raid To Riches")
  //       .setAuthor({
  //         name: "Omerta Raid to Earn",
  //       })
  //       .addFields(
  //         {
  //           name: "\u200b",
  //           value:
  //             "`1` Create an account with the bot using #raid-and-earn or #shop channels",
  //           inline: false,
  //         },
  ...
  //           name: "\u200b",
  //           value:
  //             "`2` **LIKE**, **COMMENT**, and **RETWEET** to earn points. You can then spend those points in the shop to purchase prizes, whitelist, roles & more.",
  //           inline: false,
  //         },
  ...
  //         }
  //       )
  //       .setFooter({ text: "Powered by Project Omerta" });
  ...
  if (msg.content.startsWith(`${process.env.prefix}shop`)) {
    try {
      ...
      let embed = new EmbedBuilder()
        .setColor(0x0099ff)
        .setAuthor({
          name: "Welcome to the Omerta Bottega",
          // iconURL:
          //   "https://about.twitter.com/content/dam/about-twitter/en/brand-toolkit/brand-download-img-1.jpg.twimg.1920.jpg",
        })
        .addFields(
          {
            name: "\u200b",
            value:
              "Welcome to the Omerta Bottega! You can come here to buy roles, whitelist, & more.",
            inline: false,
          },

          {
            name: "\u200b",
            value:
              "This is the place to shop around at. Click on the **View Store Items** button below to display a dropdown for all store items. You could then select an item to view it's details and buy it.",
            inline: false,
          }
        )
        .setFooter({ text: "Powered by Project Omerta" });
...
client.on("interactionCreate", async (interaction) => {
      ...
      async (e, accessToken, accessTokenSecret) => {
        if (e) {
          let embed = new EmbedBuilder()
            ...
            .setFooter({
              text: "Powered by Project Omerta",
            });
  ...
  if (interaction.customId.split(" ")[0] === "checkBalance") {
    try {
      let embed = new EmbedBuilder()
        .setColor(0x0099ff)
        .setTitle(`Welcome to the Omerta Bank`)
        .addFields({
